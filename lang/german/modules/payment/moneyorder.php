...
if(MODULE_PAYMENT_MONEYORDER_PAYTO !='')
	$payto = nl2br(MODULE_PAYMENT_MONEYORDER_PAYTO);
else
	$payto = 'Tragen Sie hier die Bankdaten des Empf&auml;ngers ein.';
	
define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', '<u>Zahlbar an:</u><br />'. $payto . '<br /><br /><u>Adressat:</u><br />' . nl2br(STORE_NAME_ADDRESS) . '<br /><br />' . '');
define('MODULE_PAYMENT_MONEYORDER_TEXT_EMAIL_FOOTER', '<u>Zahlbar an:</u> '. $payto . '<br /><br /><u>Adressat:</u><br />' . STORE_NAME_ADDRESS . "\n\n" . '');
