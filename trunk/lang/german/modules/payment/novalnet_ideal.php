...
define('MODULE_PAYMENT_NOVALNET_IDEAL_PAYMENT_LOGO_TITLE', '<NOBR><A HREF="https://www.novalnet.de" TARGET="_new"><IMG SRC="' . $request_server_type . '://www.novalnet.de/img/ideal_payment_small.png" ALT="iDEAL" height = "35px" width = "35px" title="iDEAL" BORDER="0"></A></NOBR><br>');
