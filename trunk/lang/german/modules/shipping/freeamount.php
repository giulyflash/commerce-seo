<?php
/*-----------------------------------------------------------------
* 	$Id: freeamount.php 496 2013-07-17 09:56:08Z akausch $
...
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_WAY', '<em>ab %s  Bestellwert versenden wir Ihre Bestellung versandkostenfrei</em>');
...
define('MODULE_SHIPPING_FREEAMOUNT_STATUS_DESC' , 'Möchten Sie Versandkostenfreie Lieferung anbieten?');
