<?php
/*-----------------------------------------------------------------
* 	$Id: buttons.php 420 2013-06-19 18:04:39Z akausch $
...
define('BUTTON_INVOICE', 'HTML-Rechnung');
define('BUTTON_PACKINGSLIP', 'HTML-Lieferschein');
...
define('CSEO_BUTTON_ADD_SPECIAL', 'Sonderangebot');
define('PDF_ACTION','gew&auml;hlte PDF-Aktion durchf&uuml;hren');
define('BUTTON_NEWPRODUCT','Als neues Produkt speichern');
?>