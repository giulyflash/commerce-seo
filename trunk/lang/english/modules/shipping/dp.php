...
define('MODULE_SHIPPING_DP_STATUS_DESC' , 'Wollen Sie den Versand РЎРЉber die deutsche Post anbieten?');
define('MODULE_SHIPPING_DP_HANDLING_TITLE' , 'Handling Fee');
define('MODULE_SHIPPING_DP_HANDLING_DESC' , 'BearbeitungsgebРЎРЉhr fРЎРЉr diese Versandart in Euro');
define('MODULE_SHIPPING_DP_TAX_CLASS_TITLE' , 'Steuersatz');
define('MODULE_SHIPPING_DP_TAX_CLASS_DESC' , 'WР Т‘hlen Sie den MwSt.-Satz fРЎРЉr diese Versandart aus.');
define('MODULE_SHIPPING_DP_ZONE_TITLE' , 'Versand Zone');
define('MODULE_SHIPPING_DP_ZONE_DESC' , 'Wenn Sie eine Zone auswР Т‘hlen, wird diese Versandart nur in dieser Zone angeboten.');
...
define('MODULE_SHIPPING_DP_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand mРЎвЂ glich sein soll. zb AT,DE');
