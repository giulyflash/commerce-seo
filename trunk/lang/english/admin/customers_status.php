...
define('TEXT_INFO_CUSTOMERS_STATUS_BASE', '<b>Basis Kundengruppe fРЎРЉr Artikelpreise</b>');
define('ENTRY_CUSTOMERS_STATUS_BASE', 'wird als Grundlage fРЎРЉr die Preise der neuen Kundengruppe gewР Т‘hlt. Wenn Auswahl = Admin werden keine Preise fРЎРЉr die neue Kundengruppe angelegt.');
