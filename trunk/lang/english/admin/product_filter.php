...
define('HEADING_TITLE','Product Filter PRO v 2');

define('TABLE_HEADING_NAVIGATION','Navigation:');
define('TABLE_HEADING_INFOCENTER_TOPIC','sites: ');
define('TABLE_HEADING_INFOCENTER_TOPIC_OFF','Offline: ');

define('TABLE_HEADING_NAVIGATION_OVERVIEW','Overview');
define('TABLE_HEADING_NAVIGATION_NEWCATEGORIE','New Categorie');
define('TABLE_HEADING_NEWCATEGORIE_STATUS','Status');
define('TABLE_HEADING_NAVIGATION_NEWITEM','New Kriterium');
define('TABLE_HEADING_NAVIGATION_STARTSITE','Frontpage bearbeiten');
