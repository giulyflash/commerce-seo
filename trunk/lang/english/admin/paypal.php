...
/* ACHTUNG ! Texte nicht Р Т‘ndern da Status abfrage im Programm */
...
define('STATUS_REFUNDED','ZurРЎРЉckgezahlt');
define('STATUS_REVERSED','Reversed');
define('STATUS_DENIED','Storniert');
define('STATUS_CASE','KР Т‘uferkonflikt');
define('STATUS_CANCELED_REVERSAL','RРЎРЉcklastschrift');
define('STATUS_CANCELLED_REVERSA','RРЎРЉcklastschrift');
define('STATUS_EXPIRED','Abgelaufen');
define('STATUS_FAILED','Fehlgeschlagen');
define('STATUS_IN-PROGRESS','In Bearbeitung');
define('STATUS_PARTIALLY_REFUNDE','Teilweise ZurРЎРЉckgezahlt');
