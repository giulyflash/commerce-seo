<?php
/* -----------------------------------------------------------------
 * 	$Id: banner_manager.php 420 2013-06-19 18:04:39Z akausch $
        ...
        <td class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                <tr>
                    <td><table class="table_pageHeading" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="pageHeading"><?php echo HEADING_TITLE_BANNER_MANAGER; ?></td>
                            </tr>
                        </table></td>
                </tr>
                <?php
    ...
    $(function() {
        $('.datepickers').datepicker({
            ...
            dateFormat: 'yy-mm-dd'});
                    ...
                    <tr><?php echo xtc_draw_form('new_banner', FILENAME_BANNER_MANAGER, 'page=' . $_GET['page'] . '&action=' . $form_action, 'post', 'enctype="multipart/form-data"');
                if ($form_action == 'update') echo xtc_draw_hidden_field('banners_id', $bID); ?>
                        <td><table border="0" cellspacing="0" cellpadding="2">
                                ...
                                <tr>
									...
									<input type="text" name="date_scheduled" class="datepickers" value="<?php echo ($bInfo->date_scheduled != '00.00.0000' ? $bInfo->date_scheduled : ''); ?>" />
									</td>
                                </tr>
                                <tr>
                                    <td valign="top" class="main"><?php echo TEXT_BANNERS_EXPIRES_ON; ?><br /><small>(dd/mm/yyyy)</small></td>
                                    <td class="main">
										<input type="text" name="expires_date" class="datepickers" value="<?php echo ($bInfo->expires_date != '00.00.0000' ? $bInfo->expires_date : ''); ?>" /><br>
                                    ...
                                    <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            ...
                                            while ($banners = xtc_db_fetch_array($banners_query)) {
                                                ...
                                                if ((is_object($bInfo)) && ($banners['banners_id'] == $bInfo->banners_id)) {
                                                    echo '<tr class="dataTableRowSelected" onclick="document.location.href=\'' . xtc_href_link(FILENAME_BANNER_STATISTICS, 'page=' . $_GET['page'] . '&bID=' . $bInfo->banners_id) . '\'">' . "\n";
                                                } else {
                                                    echo '<tr class="' . (($i % 2 == 0) ? 'dataTableRow' : 'dataWhite') . '" onclick="document.location.href=\'' . xtc_href_link(FILENAME_BANNER_MANAGER, 'page=' . $_GET['page'] . '&bID=' . $banners['banners_id']) . '\'">' . "\n";
                                                }
                                                ?>
