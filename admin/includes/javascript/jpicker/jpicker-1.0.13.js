...
(function($, version)
{
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: 'includes/javascript/jpicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
      ...
      localization:
        {
          text:
          {
            title: 'Bewege den Marker um eine Hintergrungfarbe zu w&auml;hlen',
            newColor: 'neu',
