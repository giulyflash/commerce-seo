<?php
/* -----------------------------------------------------------------
 * 	$Id: billsafe_orders_2.php 420 2013-06-19 18:04:39Z akausch $
...
if (isset($_POST['reportShipmentFull'])) {
    ...
    if ($total < 0)
        $orderIDArr = getTotal0($order_id, 'retoure');
    ...
    getTotalsOrderProducts($order_id);
    if ($total < 0)
        $orderIDArr = getTotal0($order_id, 'storno');
    ...
    if ($dpaymentAmount == '')
        $dpaymentAmount = 0;
    if ($dpaymentAmountKomma == '')
        $dpaymentAmountKomma = 0;
...
?>
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="2"><form action="<?php echo $post_url ?>" method="POST"><tr class="dataTableHeadingRow">
                                ...
                                ?><tr><td colspan='9' align='right'><?php if ($countOrder['quantity'] == $countUsed['quantity']) { ?>
                        ...
                        <br /><?php
                            ...
                            <form action="<?php echo $post_url ?>" method="POST"><?php
                                ...
                                ?>
                                <td colspan="9" align="right"><?php if ($countOrder['quantity'] == $countNotRetoure['quantity']) { ?>
                                ...
                                <td><table border="0" cellspacing="0" cellpadding="2"><tr class="dataTableHeadingRow">
                                            ...
                                            <td class="dataTableContent" align="right" valign="top">
                                                <form id="voucher" method="POST" action="<?php echo $post_url ?>">
                                                    <input id="voucherAmount" type="text" style="float:none;" maxlength="4" name="voucherAmount" size="4" value="" />,<input style="float:none;" id="voucherAmountKomma" type="text" maxlength="2" name="voucherAmountKomma" size="2" value="" />&nbsp;<?php echo $currency; ?>,&nbsp;<?php echo MODULE_PAYMENT_BILLSAFE_2_TAX . ': ';
echo xtc_draw_pull_down_menu('voucherTax', $tax_class_array, $tax_class_id); ?><br /><br />
