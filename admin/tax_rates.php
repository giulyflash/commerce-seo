<?php
/* -----------------------------------------------------------------
 * 	$Id: tax_rates.php 486 2013-07-15 22:08:14Z akausch $
                                    ...
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
                                        ...
                                        while ($rates = xtc_db_fetch_array($rates_query)) {
                                            ...
                                            if ((is_object($trInfo)) && ($rates['tax_rates_id'] == $trInfo->tax_rates_id)) {
                                                echo '<tr class="dataTableRowSelected" onclick="document.location.href=\'' . xtc_href_link(FILENAME_TAX_RATES, 'page=' . $_GET['page'] . '&tID=' . $trInfo->tax_rates_id . '&action=edit') . '\'">' . "\n";
                                            } else {
                                                echo '<tr class="' . (($i % 2 == 0) ? 'dataTableRow' : 'dataWhite') . '" onclick="document.location.href=\'' . xtc_href_link(FILENAME_TAX_RATES, 'page=' . $_GET['page'] . '&tID=' . $rates['tax_rates_id']) . '\'">' . "\n";
                                            }
                                            ?>
                                            ...
                                            <td class="dataTableContent" align="right"><?php if ((is_object($trInfo)) && ($rates['tax_rates_id'] == $trInfo->tax_rates_id)) {
