<?php
/*-----------------------------------------------------------------
* 	$Id: content.php 434 2013-06-25 17:30:40Z akausch $
...
if (!$box_smarty->isCached(CURRENT_TEMPLATE.'/boxes/box_content.html', $cache_id) || !$cache) {
	...
	$getChild = xtc_db_fetch_array(xtc_db_query("SELECT parent_id FROM content_manager WHERE content_group = '".(int)$_GET['coID']."'"));
