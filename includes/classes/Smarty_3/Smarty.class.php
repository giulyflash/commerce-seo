 ...
 * SVN:         $Id: Smarty.class.php 469 2013-07-09 08:35:36Z akausch $
 *
...
if (!defined('SMARTY_PLUGINS_DIR')) {
	...
	define('SMARTY_CSEO_PLUGINS_DIR', SMARTY_DIR . 'cseo_plugins' . DS);
}
...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function __construct()
    {
        ...
        $this->template_html_dir = array('.' . DS . 'templates' . DS . CURRENT_TEMPLATE . DS . 'html'. DS);
        $this->compile_dir = '.' . DS . 'templates_c' . DS;
        $this->plugins_dir = array(SMARTY_PLUGINS_DIR, SMARTY_CSEO_PLUGINS_DIR);
